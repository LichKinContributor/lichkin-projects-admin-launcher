...
,('20180101000000000_09_t_sys_category_PSS_STOCK_IN_TYPE_0000000000','zh_CN',5,'ROOT','PSS_STOCK_IN_TYPE','入库类型')
,('20180101000000000_10_t_sys_category_PSS_STOCK_OUT_TYPE_000000000','zh_CN',5,'ROOT','PSS_STOCK_OUT_TYPE','出库类型')
ON DUPLICATE KEY UPDATE 
LOCALE=VALUES(LOCALE),SORT_ID=VALUES(SORT_ID),AUTH_TYPE=VALUES(AUTH_TYPE),CATEGORY_CODE=VALUES(CATEGORY_CODE),CATEGORY_NAME=VALUES(CATEGORY_NAME)
;
