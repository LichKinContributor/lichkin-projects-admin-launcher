...
,('20180101000000000_08_t_sys_category_PSS_STORAGE_IN_TYPE_00000000','zh_CN',5,'ROOT','PSS_STORAGE_IN_TYPE','入库类型')
,('20180101000000000_08_t_sys_category_PSS_STORAGE_OUT_TYPE_0000000','zh_CN',5,'ROOT','PSS_STORAGE_OUT_TYPE','出库类型')
ON DUPLICATE KEY UPDATE 
LOCALE=VALUES(LOCALE),SORT_ID=VALUES(SORT_ID),AUTH_TYPE=VALUES(AUTH_TYPE),CATEGORY_CODE=VALUES(CATEGORY_CODE),CATEGORY_NAME=VALUES(CATEGORY_NAME)
;
