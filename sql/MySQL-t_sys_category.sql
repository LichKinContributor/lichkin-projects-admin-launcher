...
,('20180101000000000_12_t_sys_category_ADMIN_BUS_TYPE_0000000000000','zh_CN',1,'ENUM','ADMIN_BUS_TYPE','管理员业务操作类型')
,('20180101000000000_13_t_sys_category_EMPLOYEE_BUS_TYPE_0000000000','zh_CN',1,'ENUM','EMPLOYEE_BUS_TYPE','员工业务操作类型')
,('20180101000000000_14_t_sys_category_USER_BUS_TYPE_00000000000000','zh_CN',1,'ENUM','USER_BUS_TYPE','用户业务操作类型')
...
,('20180101000000000_03_t_sys_category_ACTIVITI_PROCESS_CODE_000000','zh_CN',2,'ENUM','ACTIVITI_PROCESS_CODE','流程编码')
...
-- attendance
INSERT INTO t_sys_category (ID,LOCALE,SORT_ID,AUTH_TYPE,CATEGORY_CODE,CATEGORY_NAME) VALUES 
 ('20180101000000000_01_t_sys_category_SCHEDULE_TYPE_00000000000000','zh_CN',4,'ENUM','SCHEDULE_TYPE','排班类型')
ON DUPLICATE KEY UPDATE 
LOCALE=VALUES(LOCALE),SORT_ID=VALUES(SORT_ID),AUTH_TYPE=VALUES(AUTH_TYPE),CATEGORY_CODE=VALUES(CATEGORY_CODE),CATEGORY_NAME=VALUES(CATEGORY_NAME)
;
...
,('20180101000000000_05_t_sys_category_PSS_OTHER_STOCK_IN_000000000','zh_CN',5,'COMP','PSS_OTHER_STOCK_IN','其它入库类型')
,('20180101000000000_06_t_sys_category_PSS_OTHER_STOCK_OUT_00000000','zh_CN',5,'COMP','PSS_OTHER_STOCK_OUT','其它出库类型')
...
,('20180101000000000_09_t_sys_category_PSS_STOCK_IN_TYPE_0000000000','zh_CN',5,'ENUM','PSS_STOCK_IN_TYPE','入库类型')
,('20180101000000000_10_t_sys_category_PSS_STOCK_OUT_TYPE_000000000','zh_CN',5,'ENUM','PSS_STOCK_OUT_TYPE','出库类型')
ON DUPLICATE KEY UPDATE 
LOCALE=VALUES(LOCALE),SORT_ID=VALUES(SORT_ID),AUTH_TYPE=VALUES(AUTH_TYPE),CATEGORY_CODE=VALUES(CATEGORY_CODE),CATEGORY_NAME=VALUES(CATEGORY_NAME)
;
