...
$.LKExtendICON({
  'employeeScheduleConfigMgmt' : 'user-cog',
});
$.LKExtendICON({
  'employeeAttendanceMgmt' : 'user-check',
});
$.LKExtendICON({
...
$.LKExtendICON({
  'purchaseReturnNotStockInOrder' : 'arrow-left',
});
$.LKExtendICON({
...
$.LKExtendICON({
  'sellReturnStockOutOrder' : 'arrow-alt-circle-right',
});
